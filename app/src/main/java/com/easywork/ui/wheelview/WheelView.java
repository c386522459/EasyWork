...
//	private GradientDrawable bottomShadow;
	...
	public void setItemHeight(int height) {
		this.ADDITIONAL_ITEM_HEIGHT = height;
		invalidate();
	}
...
//	}
	...
	private void drawValue(Canvas canvas) {
		...
		if (labelLayout != null) {
			canvas.save();
			canvas.translate(itemsLayout.getWidth() + LABEL_OFFSET, bounds.top + OFFSET);
		...
		if (valueLayout != null) {
			canvas.save();
			canvas.translate(0, bounds.top + scrollingOffset + OFFSET);
	...
	private void drawItems(Canvas canvas) {
		...
		canvas.translate(0, - top + scrollingOffset + OFFSET);
	...
	*/
	...
	/**
	 * if scrolling then return true else return false
	 * @return
	 */
