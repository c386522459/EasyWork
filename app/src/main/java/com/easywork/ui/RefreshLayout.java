...
public class RefreshLayout extends SwipeRefreshLayout implements OnScrollListener {
    ...
    public RefreshLayout(Context context) {
        this(context, null);
        mListViewFooter = LayoutInflater.from(context).inflate(R.layout.widget_refresh_footer,null);
    }
     ...
     * @description
     *
     * @param mListViewFooter 加载等待视图
     */
    public void setFootView(View mListViewFooter) {
