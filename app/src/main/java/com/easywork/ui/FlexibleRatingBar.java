	...
	private void getXmlAttrs(Context context, AttributeSet attrs) {
		...
		try {
			...
			strokeWidth = (int) a.getDimension(
					R.styleable.FlexibleRatingBar_ratingStrokeWidth, -1);

			// colorOutlineOn =
			// a.getInteger(R.styleable.FlexibleRatingBar_colorOutlineOn,
			// Color.rgb(0x11, 0x11, 0x11));
			// colorOutlineOff =
			// a.getInteger(R.styleable.FlexibleRatingBar_colorOutlineOff,
			// Color.rgb(0x61, 0x61, 0x61));
			// colorOutlinePressed =
			// a.getInteger(R.styleable.FlexibleRatingBar_colorOutlinePressed,
			// Color.rgb(0xFF, 0xB7, 0x4D));
			// colorFillOn =
			// a.getInteger(R.styleable.FlexibleRatingBar_colorFillOn,
			// Color.rgb(0xFF, 0x98, 0x00));
			// colorFillOff =
			// a.getInteger(R.styleable.FlexibleRatingBar_colorFillOff,
			// Color.TRANSPARENT);
			// colorFillPressedOn =
			// a.getInteger(R.styleable.FlexibleRatingBar_colorFillPressedOn,
			// Color.rgb(0xFF, 0xB7, 0x4D));
			// colorFillPressedOff =
			// a.getInteger(R.styleable.FlexibleRatingBar_colorFillPressedOff,
			// Color.TRANSPARENT);
			// polygonVertices =
			// a.getInteger(R.styleable.FlexibleRatingBar_polygonVertices, 5);
			// polygonRotation =
			// a.getInteger(R.styleable.FlexibleRatingBar_polygonRotation, 0);
			// strokeWidth = (int)
			// a.getDimension(R.styleable.FlexibleRatingBar_strokeWidth, -1);
		} finally {
			a.recycle();
		}
	}
